				...
				<div class="col-md-4 mb-4">
					...
					<div class="card">
						<div class="card-body">
							...
							<span class="pl-sm-5"><b>Subject Name</b><span style="color:red; ">*</span></span>
							</br>	<i class="fa fa-book prefix grey-text css" style="font-size: 1rem; padding-bottom: 11px;"></i> <input type="text"
								...
								<span class="pl-sm-5"><b>Course</b><span style="color:red;">*</span></span>
								 </br> <i class="fa fa-user-md prefix grey-text css" style="font-size: 1rem;"></i>
