...
<body class="hm-gradient">
	...
	<div>
		<form action="<%=ORSView.ROLE_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="in.co.rays.dto.RoleDTO" scope="request"></jsp:useBean>
			<%
			...
			<div class="row">
				<div class="col-sm-5" style="margin-left: -60px;"></div>

				<div class="col-sm-2"><%=HTMLUtility.getList("Role", String.valueOf(dto.getId()), list1)%></div>
					...
					<tbody>
						<tr>
							<td align="center"><input type="checkbox" class="checkbox"
								...
								<%if (dto.getId() == RoleDTO.ADMIN) {%> <%="disabled"%> <%}%>>
							</td>
			...
			%>
			<center>
				<h1 style="font-size: 40px; padding-top: 15px; color: #164590;">Role
					List</h1>
			</center>
			</br>
			<div class="row">
