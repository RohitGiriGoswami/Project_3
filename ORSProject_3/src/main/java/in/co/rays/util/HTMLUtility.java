...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal, HashMap<String, String> map) {
        ...
        StringBuffer sb = new StringBuffer("<select class='dropdown-item' style='border: 3px solid #8080803b;' class='form-control' name='" + name + "'>");
	...
	public static String getList(String name, String selectedVal, List list) {
        ...
        StringBuffer sb = new StringBuffer("<select class='dropdown-item' style='width: 325px;  height: 35px; border: 2px solid #8080803b; background-color:white;' class='form-control' name='" + name + "'>");

        boolean select=true;
        if (select)
        {

            sb.append("<option class='dropdown-item' style='border: 3px solid #8080803b;' selected value=''>--------"+ name +"----------</option>");
        }
